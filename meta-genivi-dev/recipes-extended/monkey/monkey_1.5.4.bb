...
SRC_URI = "http://monkey-project.com/releases/1.5/monkey-${PV}.tar.gz \
           file://monkey.service \
           file://monkey.init \
           git://git@git.igalia.com:4428/chromium/demos.git;protocol=ssh;rev=8615e66b6feeaf60021d10dc53229641714682db;destsuffix=demos \
           "
...
do_install_append() {
    ...
    # demos
    # HTML5-video
    DEMO_NAME=HTML5-video
    DEMO_DIR=${WORKDIR}/demos/$DEMO_NAME
    install -d ${D}${localstatedir}/www/monkey/$DEMO_NAME
    install -m 0755 $DEMO_DIR/${DEMO_NAME}.html ${D}${localstatedir}/www/monkey/$DEMO_NAME
    install -m 0755 $DEMO_DIR/${DEMO_NAME}.png  ${D}${localstatedir}/www/monkey/$DEMO_NAME
    install -d ${D}${localstatedir}/www/monkey/$DEMO_NAME/${DEMO_NAME}_files
    install -m 0755 $DEMO_DIR/${DEMO_NAME}_files/* ${D}${localstatedir}/www/monkey/$DEMO_NAME/${DEMO_NAME}_files
}
